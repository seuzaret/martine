...
const ACTIONS = {
  ...
  nathalie: { mood: "content",
    ...
    jeu2Variants: [
      { bubble: "Une dame en tunique grise est venue voir la Lune avec nous, ICI dans le salon. Elle a laissé un CD gravé sur le meuble de la télé.",
        say: "Nathalie : ICI AU SALON DE 1969, sur le meuble télé." },
      { bubble: "La chronaute est repartie 15 ans plus tard, dans ma chambre d'ado. Elle a caché son CD dans ma pile de cassettes.",
        say: "Nathalie renvoie À LA CHAMBRE 1985, dans la pile de cassettes." },
      { bubble: "Elle a filé au bureau de ma tante, dans les années 90. Elle a posé son CD à côté du PC.",
        say: "Nathalie renvoie AU BUREAU 1990, à côté du PC." },
    ] },
  ...
  julien: { mood: "content",
    ...
    jeu2Variants: [
      { bubble: "Une dame chronaute a laissé un CD à mes parents, LA NUIT DE LA LUNE en 69, dans leur salon. Va voir plutôt là.",
        say: "Julien renvoie AU SALON DE 1969, sur le meuble télé." },
      { bubble: "Une chronaute est passée ICI, dans ma chambre. Elle a glissé son CD gravé dans ma pile de cassettes, camouflé.",
        say: "Julien : ICI DANS LA CHAMBRE 1985, dans la pile de cassettes." },
      { bubble: "Elle a filé au bureau du studio graphique, quelques années plus tard. Sa dernière version du CD est là-bas, à côté du PC.",
        say: "Julien renvoie AU BUREAU 1990, à côté du PC." },
    ] },
  ...
  celine: { mood: "neutre",
    ...
    jeu2Variants: [
      { bubble: "Al3x1A m'a emprunté un CD vierge, puis a couru le graver dans le SALON DE 1969, sur le meuble télé. Un souvenir de la nuit lunaire.",
        say: "Céline renvoie AU SALON 1969, sur le meuble télé." },
      { bubble: "Elle a laissé un exemplaire dans la chambre d'ado de Julien, glissé dans sa pile de cassettes.",
        say: "Céline renvoie À LA CHAMBRE 1985, dans la pile de cassettes." },
      { bubble: "Elle a laissé un exemplaire ICI, à côté de mon PC. Elle disait que je pourrais peut-être encore le lire — pour combien de temps ?",
        say: "Céline : ICI AU BUREAU 1990, à côté du PC." },
    ] },
