...
const ACTIONS = {
  ...
  james: { mood: "content",
    ...
    jeu2: {
      bubble: "Une chronaute en tunique grise a télégraphié un message étrange depuis MON BUREAU DU TÉLÉGRAPHE, juste ici. Le télégramme est resté épinglé au mur, derrière le manipulateur. Va voir.",
      say: "James pointe le bureau du télégraphe : télégramme épinglé au mur." } },
  photographe: { mood: "neutre",
    ...
    jeu2: {
      bubble: "Elle s'est fait tirer le portrait chez moi, mais avant elle a laissé un télégramme AU BUREAU DU TÉLÉGRAPHE, la boutique voisine. Va voir James, il te montrera où c'est affiché.",
      say: "Le photographe renvoie au bureau du télégraphe. C'est là que se trouve la note." } },
  ...
  marconi: { mood: "vexe",
    ...
    jeu2: {
      bubble: "Al3x1A a laissé un télégramme codé, oui. Mais il n'est pas ici, il est resté au BUREAU DU TÉLÉGRAPHE de James, dans le Far West. Va voir là-bas.",
      say: "Marconi renvoie au bureau du télégraphe : c'est là que la note est archivée." } },
