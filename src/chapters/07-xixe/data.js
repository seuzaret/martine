...
const MESSAGES = {
  ...
  msg_daguerreotype: { title: "Daguerréotype (photographie)", emoji: "📷",
  ...
  msg_phonographe: { title: "Phonographe Edison (voix enregistrée)", emoji: "🎙️",
  ...
  msg_cinema: { title: "Cinématographe (Lumière) & Nickelodeon", emoji: "🎞️",
