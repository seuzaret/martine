...
const ACTIONS = {
  ...
  james: { mood: "content",
    ...
    jeu2Variants: [
      { bubble: "La chronaute a télégraphié un message étrange ICI. Le télégramme est resté épinglé au mur, derrière le manipulateur.",
        say: "James : ICI au BUREAU DU TÉLÉGRAPHE, sur le mur derrière le manipulateur." },
      { bubble: "Elle a filé se faire tirer le portrait au studio du daguerréotype voisin. Elle a laissé sa marque sur le mur du fond, là-bas.",
        say: "James renvoie AU STUDIO DU DAGUERRÉOTYPE, sur le mur du fond." },
      { bubble: "Al3x1A a fini par courir à la station Marconi, la TSF. Elle a laissé son télégramme près du poste, au bout du monde.",
        say: "James renvoie À LA STATION MARCONI, près du poste." },
    ] },
  photographe: { mood: "neutre",
    ...
    jeu2Variants: [
      { bubble: "Elle a laissé un télégramme AU BUREAU DU TÉLÉGRAPHE voisin. James saura où c'est affiché, sur le mur derrière le manipulateur.",
        say: "Le photographe renvoie AU BUREAU DU TÉLÉGRAPHE." },
      { bubble: "Elle a laissé son télégramme ICI, chez moi, sur le mur du fond du studio. Un beau souvenir, je l'y ai encadré.",
        say: "Le photographe : ICI au STUDIO DU DAGUERRÉOTYPE, sur le mur du fond." },
      { bubble: "Elle a couru à la station Marconi, la TSF. Elle a laissé son télégramme là-bas, près du poste — les ondes, l'avenir, tout ça.",
        say: "Le photographe renvoie À LA STATION MARCONI, près du poste." },
    ] },
  ...
  marconi: { mood: "vexe",
    ...
    jeu2Variants: [
      { bubble: "Le télégramme d'Al3x1A est resté au BUREAU DU TÉLÉGRAPHE de James, dans le Far West. Va voir là-bas, sur le mur.",
        say: "Marconi renvoie AU BUREAU DU TÉLÉGRAPHE." },
      { bubble: "Elle est allée se faire tirer le portrait au studio du daguerréotype. Son télégramme est resté sur le mur du fond, encadré.",
        say: "Marconi renvoie AU STUDIO DU DAGUERRÉOTYPE, sur le mur du fond." },
      { bubble: "Al3x1A a laissé son télégramme ICI, à ma station. Près du poste, dans un coin. Elle disait que les ondes le porteraient jusqu'au futur.",
        say: "Marconi : ICI à LA STATION MARCONI, près du poste." },
    ] },
