...
<<<<<<< HEAD
        ...
        {step === 0 && (
          <>
            <p style={{ fontSize: 13, lineHeight: 1.55, textAlign: "center", margin: "0 0 12px", color: "#3a2e1e", fontStyle: "italic" }}>
              Le téléphone du kiosque sonne. Robert décroche, tend le combiné en te chuchotant : « C'est pour toi. »
            </p>
            {/* Bulle-dialogue façon vieux téléphone : le/la journaliste parle */}
            <div style={{ position: "relative", background: "#fff", border: `2px solid ${journal.couleur}`, borderRadius: 14, padding: "16px 18px 14px 62px" }}>
              {/* petite icône combiné à gauche */}
              <div style={{ position: "absolute", left: 14, top: 16, width: 34, height: 34, background: journal.couleur, borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 18 }}>📞</div>
              <div style={{ fontFamily: "ui-monospace,monospace", fontSize: 10, letterSpacing: 2, color: journal.couleur, marginBottom: 4, fontWeight: 800 }}>
                ▸ {journal.perso.toUpperCase()} · {journal.titrePerso.toUpperCase()} · {journal.nom.toUpperCase()}
              </div>
              <p style={{ fontSize: 14, lineHeight: 1.55, color: "#1c1a10", margin: 0, fontStyle: "italic" }}>« {journal.accroche} »</p>
            </div>
            {/* résumé fiche du journal */}
