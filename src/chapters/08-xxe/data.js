/* ============================================================
   ...
   ============================================================
   3 tableaux, un message qui traverse la Manche.
   - T1 : PARIS OCCUPÉ (jour). Rue parisienne, Tour Eiffel avec
     drapeau à croix gammée, patrouille allemande, marchand
     clandestin sous une arcade. Marthe achète discrètement une
     grosse couverture pour cacher sa TSF cette nuit.
   - T2 : STUDIO BBC, Bush House, Londres, 5 juin 1944 au soir.
     Arthur Smith, ingénieur du son, prépare l'émission.
     micro + poème → message émis vers l'Europe occupée.
   - T3 : SALON DUPONT, Paris occupé, nuit. Marthe assemble
     TSF + antenne + couverture, puis règle la fréquence dans
     le brouillage nazi (mini-jeu). Signal du Débarquement.
...
import { PortraitArthur, PortraitMarthe, PortraitMarchand } from "./scenes/portraits.jsx";
...
const SCENES = [
  ...
  { id: "salon", name: "Salon Dupont, Paris (nuit, 5 au 6 juin)", Component: SceneSalon },
];
