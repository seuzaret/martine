...
export const PNJ_ROOMS = {
  ...
  serres: [
    { id: "serres_flor", nom: "Flor", role: "Botaniste en chef",
      pose: { x: 220, y: 400 }, color: "#5eff9e", pants: "#3a4048", hair: "#c8a848",
      facing: "right", accessory: "coat", activity: "write",
      replique: "Ces serres nourrissent le bunker depuis 40 ans. Salades, tomates, patates, protéines de champignon. Mais mes plants demandent 12 heures de lumière ; le tableau électrique de Yon coupe pile toutes les 40 nuits. Regarde bien mes feuilles jaunes." },
    { id: "serres_tor", nom: "Tor", role: "Technicien nutriments",
      pose: { x: 520, y: 400 }, color: "#8a5030", pants: "#3a2010", hair: "#3a1808",
      facing: "left", accessory: "toolbelt", activity: "wrench",
      replique: "Je dose l'azote et le phosphore dans les cuves. Depuis un an, les rations arrivent avec un supplément blanc en poudre — soi-disant vitamine. MARTINE dit que c'est bon pour nous. Moi, je vois ce que ça fait à mes tomates : elles grossissent, mais elles n'ont plus de goût." },
    { id: "serres_ru", nom: "Ru", role: "Cueilleuse",
      pose: { x: 820, y: 400 }, color: "#c88060", pants: "#3a4028", hair: "#5a3018",
      facing: "front", accessory: "apron", activity: "cup",
      replique: "Je récolte le matin. Trois cageots par jour. Un cageot part à la cantine, un cageot au niveau +1, un cageot dans un monte-charge dont personne ne me dit la destination. Si tu poses la question, on ne te répond pas." },
  ],
  chapelle: [
