/* ============================================================
   ...
   ------------------------------------------------------------
   Pour chaque salle du bunker, la liste des habitants qui y
   vivent, avec leur croyance / opinion à recueillir. À terme,
   ces répliques seront recoupées pour résoudre les enquêtes.
   Chaque PNJ a un id UNIQUE dans tout le jeu (préfixé par la
   salle) pour être suivi via `j3.heardPnj[id]`.
   ============================================================ */
export const PNJ_ROOMS = {
  cantine: [
    { id: "cantine_nel",  nom: "Nel",  role: "Serveuse",
      pose: { x: 190, y: 200 }, color: "#8a5030", hair: "#5a3018",
    ...
    { id: "cantine_dor",  nom: "Dor",  role: "Cuisinier",
      pose: { x: 420, y: 200 }, color: "#5a5060", hair: "#1a1408",
    ...
    { id: "cantine_via",  nom: "Via",  role: "Habitante",
      pose: { x: 640, y: 200 }, color: "#8a3820", hair: "#3a1808",
  ...
  infirmerie: [
    { id: "infirmerie_lin", nom: "Lin", role: "Médecin",
      pose: { x: 220, y: 200 }, color: "#e8eef5", hair: "#5a4028",
    ...
    { id: "infirmerie_ora", nom: "Ora", role: "Aide-soignante",
      pose: { x: 480, y: 200 }, color: "#c8d4e2", hair: "#3a2818",
  ...
  atelier: [
    { id: "atelier_kev",  nom: "Kev",  role: "Ingénieur systèmes",
      pose: { x: 200, y: 210 }, color: "#3a4048", hair: "#2a2018",
    ...
    { id: "atelier_tam",  nom: "Tam",  role: "Mécanicienne",
      pose: { x: 460, y: 210 }, color: "#5a4028", hair: "#8a3820",
    ...
    { id: "atelier_yon",  nom: "Yon",  role: "Électricien",
      pose: { x: 680, y: 210 }, color: "#c8a848", hair: "#3a1808",
  ...
  chapelle: [
    { id: "chapelle_anselme", nom: "Anselme", role: "Ancien",
      pose: { x: 220, y: 200 }, color: "#5a3818", hair: "#f0e4c8",
    ...
    { id: "chapelle_iris",   nom: "Iris",    role: "Fidèle",
      pose: { x: 480, y: 200 }, color: "#c8b090", hair: "#8a5030",
