...
export default function Martine({ lines, idx, onNext, mood = "neutre", date }) {
  ...
  return (
    <div onClick={() => (done ? hasNext && onNext() : skip())}
      style={{ background: "#0c1410", border: "2px solid #24382c", borderRadius: 14, boxShadow: "inset 0 0 40px rgba(80,255,160,0.05)", padding: "6px 14px 6px 6px", cursor: "pointer", minHeight: 88, position: "relative", display: "flex", gap: 10, alignItems: "center" }}>
